...
from ofd_parser.OfdParser import OfdParser
...
class Ui_MainWindow(QMainWindow):
    ...
    def openFile(self):
        self.filePath,fileType = QFileDialog.getOpenFileName(self,'open OFD file','E:/','OFD file(*.ofd)')
        print('filepath: ' + self.filePath)
        ofdParser = OfdParser(self.filePath)
        self.textLines = ofdParser.outlines_list
        for l in self.textLines:
            self.textBrowser.append(l)
